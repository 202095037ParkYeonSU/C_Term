...
namespace C__Assign_Team9
{
    public partial class Form2 : Form
    {
        ...
        private void Narator()
        {
            ...
            {
                Naration.Text = $"{characterManager.character1.GetName()}(이)가 선두로 달리는 중!";
            }
            else if (CharacterImage1.Left < CharacterImage2.Left)
            {
                Naration.Text = $"{characterManager.character2.GetName()}(이)가 선두로 달리는 중!";
            }
        }
